...
import { URL_ROOT, ACTIVE, IDLE, CANCEL } from "../../utils/constants";
...
export default function CreateSurvey() {
  ...
  const saveSurvey = (status = IDLE) => {
    const requestBody = {
      ...
      // time: "time"
      // user: "username"
      // TODO: Add current date and time
    };
    ...
    api
      .post("api/add-survey", requestBody)
      .then(() => {
      ...
      .catch((response) => {
        toast.error(
          "Error creating survey: " + response.data.message || response.data
        );
      });
  };
